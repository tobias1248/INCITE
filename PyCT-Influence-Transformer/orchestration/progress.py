...
def extract_success_flag(payload: Dict[str, Any]) -> Optional[bool]:
...
def has_successful_attack(payload: Dict[str, Any]) -> bool:
    explicit = extract_success_flag(payload)
